...
import sys
import os
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'AI DAY 1')))
...
if __name__ == "__main__":
    ...
    for question in [
        "Read AI DAY 3/notice.html and tell me the total fee for CS101 and AI202 after the merit scholarship.",
        "Read AI DAY 3/fees.html and tell me the fee for CS101.",          # file does not exist
        "Read AI DAY 3/big.html and tell me how many students are listed.",
    ]:
        print("\nQ:", question)
